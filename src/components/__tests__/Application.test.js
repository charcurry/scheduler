...
describe("Application", () => {
  ...
  it("loads data, edits an interview and keeps the spots remaining for Monday the same", async () => {
    ...
    await waitForElement(() => getByText(appointment, "Charlie Curry"));
  ...
  it("shows the save error when failing to save an appointment", async () => {
    ...
    await waitForElement(() => getByText(appointment, "Could not make appointment"));

    expect(getByText(appointment, "Could not make appointment")).toBeInTheDocument();
